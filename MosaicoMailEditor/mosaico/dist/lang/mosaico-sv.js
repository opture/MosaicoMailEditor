...
var swedishstrings = {
  ...
  "Unexpected error talking to server: contact us!": "Oväntat fel vid kommunikation med server: kontakta oss!",
  "Insert here the recipient email address": "Infoga mottagarens e-post adress",
  "Test email address": "Test e-post adress",
  "Block removed: use undo button to restore it...": "Block borttaget: använd ångra knappen för att återställa det...",
  "New block added after the selected one (__pos__)": "Nytt block infogat efter det valda (__pos__)",
  "New block added at the model bottom (__pos__)": "Nytt block infogat i mallens botten (__pos__)",
  ...
  "Redo last operation": "Gör om senaste operation",
  "Show image gallery": "Visa bildgalleri",
  "Gallery": "Galleri",
  "Preview": "Granska",
  "Show live preview": "Förhandsgranska",
  "Large screen": "Stor skärm",
  "Tablet": "Surfplatta",
  "Smartphone": "Smartphone",
  "Show preview and send test": "Förhandsgranska och skicka testmail",
  "Download template": "Ladda ned mall",
  "Save template": "Spara mall",
  "Saved model is obsolete": "Sparad modell är för gammal",
  ...
  "Content": "Innehåll",
  "Edit content options": "Ändra alternativ för innehåll",
  "Style": "Utseende",
  "Edit style options": "Ändra alternativ för utseende",
  "Block __name__": "Block __name__",
  "Click or drag to add this block to the template": "Klicka eller dra för att lägga till blocket till mallen.",
  "Add": "Lägg till",
  ...
  "Loading gallery...": "Laddar galleri...",
  "The gallery is empty": "Gallerit är tomt",
  "Remove image": "Radera bild",
  "Open the image editing tool": "Open the image editing tool",
  "Upload a new image": "Ladda upp en ny bild",
  ...
  "Gallery:": "Galleri:",
  "Session images": "Sessionens bilder",
  "Recents": "Recents",
  "Remote gallery": "Fjärr galleri",
  ...
  "Drop here blocks from the \"Blocks\" tab": "Dra block hit från \"Block\"-fliken",
